...
127.0.0.1 is the localhost IP address, the IP address of another system
on your network could also be used 1800 is the port number
...
Raw timestamps are nanoseconds and are converted to milliseconds for
analysis.
...
```
    ...
    # A tibble: 6 × 4
      thread Start   End func    
       <dbl> <dbl> <dbl> <chr>   
    1      0 0.294  50.5 Thread 0
    2      1 0.325  50.5 Thread 1
    3      2 0.372  50.6 Thread 2
    4      3 0.374  50.5 Thread 3
    5      4 0.377  50.6 Thread 4
    6      5 0.497  50.6 Thread 5
